...
# Google Drive 파일 ID
file_id = '11L-t_1xyZc8P60FB_NUdQiPekLCHemhp'
...
def display_right_content(labels):
    ...
    for i, label in enumerate(labels[:3]):
        with cols[i]:
            st.image(f"https://i.ibb.co/d5fg19Q/image.jpg?text={label}", caption=f"이미지: {label}", use_column_width=True)
